 ...
 * 
 * This is one of two visitors for this demonstration.  This one changes the algorithm to calculate standard shipping for
 * a customers selections.
 */
public class StandardShippingVisitor implements ShippingCostVisitor {
	...
	public void visit(BulkPackage bulkPackage) {
		this.totalShippingCost += bulkPackage.getPrice();
		
	}

	@Override
	public void visit(FirstClassPackage firstClassPackage) {
		this.totalShippingCost += firstClassPackage.getPrice();
		
	}

	@Override
	public void visit(MediaPackage mediaPackage) {
		this.totalShippingCost += mediaPackage.getPrice();
